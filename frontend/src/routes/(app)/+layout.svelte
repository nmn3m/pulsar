...
{:else if $authStore.isAuthenticated}
  <div class="min-h-screen">
    <!-- Header -->
    <header
      class="bg-white/80 backdrop-blur-md border-b border-gray-200 shadow-lg"
    >
        ...
        <div class="flex justify-between items-center h-16">
          <div class="flex items-center">
            ...
            <nav class="ml-10 flex space-x-2">
              <a
                href="/dashboard"
                class="text-gray-600 hover:text-primary-600 hover:bg-gray-100 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200"
              >
                Dashboard
              </a>
              <a
                href="/alerts"
                class="text-gray-600 hover:text-error hover:bg-gray-100 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200"
              >
                Alerts
              </a>
              <a
