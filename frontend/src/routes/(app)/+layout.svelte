...
{:else if $authStore.isAuthenticated}
  <div class="min-h-screen">
    <!-- Header -->
    <header
      class="bg-white/80 dark:bg-space-800/80 backdrop-blur-md border-b border-gray-200 dark:border-primary-500/20 shadow-lg dark:shadow-primary-500/5"
    >
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
          <div class="flex items-center">
            <h1
              class="text-2xl font-bold text-primary-600 dark:text-primary-400 dark:text-glow-cyan"
            >
              Pulsar
            </h1>
            <nav class="ml-10 flex space-x-2">
              <a
                href="/dashboard"
                class="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 hover:bg-gray-100 dark:hover:bg-space-700/50 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200"
              >
                Dashboard
              </a>
              <a
                href="/alerts"
                class="text-gray-600 dark:text-gray-300 hover:text-accent-600 dark:hover:text-accent-400 hover:bg-gray-100 dark:hover:bg-space-700/50 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200"
              >
                Alerts
              </a>
              <a
