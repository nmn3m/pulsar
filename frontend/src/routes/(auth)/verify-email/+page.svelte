	...
	<div class="max-w-md w-full space-y-8">
		...
		<div class="bg-white dark:bg-space-800/50 backdrop-blur-sm p-8 rounded-xl border border-gray-200 dark:border-space-600 shadow-lg">
			...
			<form on:submit|preventDefault={handleVerify} class="space-y-6">
				<div>
					<label class="block text-sm font-medium text-gray-700 dark:text-gray-300 text-center mb-4">
				...
				{#if error}
					<div class="bg-red-50 dark:bg-accent-900/30 border border-red-200 dark:border-accent-500/50 text-red-600 dark:text-accent-300 px-4 py-3 rounded-lg text-center">
						{error}
					</div>
				{/if}

				{#if success}
					<div class="bg-green-50 dark:bg-green-900/30 border border-green-200 dark:border-green-500/50 text-green-600 dark:text-green-300 px-4 py-3 rounded-lg text-center">
						{success}
					</div>
				{/if}
			...
			<div class="mt-4 text-center">
				<a href="/login" class="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300">
					Back to login
				</a>
			</div>
		</div>
