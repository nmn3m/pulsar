...
CREATE INDEX idx_escalation_rules_policy_id ON escalation_rules(policy_id);
CREATE INDEX idx_escalation_rules_position ON escalation_rules(policy_id, position);
CREATE INDEX idx_escalation_targets_rule_id ON escalation_targets(rule_id);
CREATE INDEX idx_escalation_targets_target ON escalation_targets(target_type, target_id);
CREATE INDEX idx_alert_escalation_events_alert_id ON alert_escalation_events(alert_id);
CREATE INDEX idx_alert_escalation_events_next_escalation ON alert_escalation_events(next_escalation_at) WHERE next_escalation_at IS NOT NULL;
