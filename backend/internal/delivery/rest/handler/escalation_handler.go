...
func (h *EscalationHandler) List(c *gin.Context) {
	...
	policies, err := h.escalationUsecase.ListPolicies(c.Request.Context(), orgID, page, pageSize)
	if err != nil {
...
// @Produce      json
// @Security     BearerAuth
// @Param        request  body      usecase.CreateEscalationPolicyRequest  true  "Escalation policy creation request"
...
func (h *EscalationHandler) Create(c *gin.Context) {
	...
	var req usecase.CreateEscalationPolicyRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}

	policy, err := h.escalationUsecase.CreatePolicy(c.Request.Context(), orgID, &req)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
func (h *EscalationHandler) Get(c *gin.Context) {
	...
	policy, err := h.escalationUsecase.GetPolicyWithRules(c.Request.Context(), id)
	if err != nil {
...
// @Security     BearerAuth
// @Param        id       path      string                                 true  "Escalation policy ID"  format(uuid)
// @Param        request  body      usecase.UpdateEscalationPolicyRequest  true  "Escalation policy update request"
...
func (h *EscalationHandler) Update(c *gin.Context) {
	...
	var req usecase.UpdateEscalationPolicyRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}

	policy, err := h.escalationUsecase.UpdatePolicy(c.Request.Context(), id, &req)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
func (h *EscalationHandler) Delete(c *gin.Context) {
	...
	if err := h.escalationUsecase.DeletePolicy(c.Request.Context(), id); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *EscalationHandler) ListRules(c *gin.Context) {
	...
	rules, err := h.escalationUsecase.ListRules(c.Request.Context(), policyID)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
// @Security     BearerAuth
// @Param        id       path      string                               true  "Escalation policy ID"  format(uuid)
// @Param        request  body      usecase.CreateEscalationRuleRequest  true  "Escalation rule creation request"
...
func (h *EscalationHandler) CreateRule(c *gin.Context) {
	...
	var req usecase.CreateEscalationRuleRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}

	rule, err := h.escalationUsecase.CreateRule(c.Request.Context(), policyID, &req)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
func (h *EscalationHandler) GetRule(c *gin.Context) {
	...
	rule, err := h.escalationUsecase.GetRule(c.Request.Context(), ruleID)
	if err != nil {
		c.JSON(http.StatusNotFound, gin.H{"error": err.Error()})
		return
	}
...
// @Param        id       path      string                               true  "Escalation policy ID"  format(uuid)
// @Param        ruleId   path      string                               true  "Escalation rule ID"    format(uuid)
// @Param        request  body      usecase.UpdateEscalationRuleRequest  true  "Escalation rule update request"
...
func (h *EscalationHandler) UpdateRule(c *gin.Context) {
	...
	var req usecase.UpdateEscalationRuleRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}

	rule, err := h.escalationUsecase.UpdateRule(c.Request.Context(), ruleID, &req)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
func (h *EscalationHandler) DeleteRule(c *gin.Context) {
	...
	if err := h.escalationUsecase.DeleteRule(c.Request.Context(), ruleID); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *EscalationHandler) ListTargets(c *gin.Context) {
	...
	targets, err := h.escalationUsecase.ListTargets(c.Request.Context(), ruleID)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
// @Param        id       path      string                              true  "Escalation policy ID"  format(uuid)
// @Param        ruleId   path      string                              true  "Escalation rule ID"    format(uuid)
// @Param        request  body      usecase.AddEscalationTargetRequest  true  "Escalation target request"
...
func (h *EscalationHandler) AddTarget(c *gin.Context) {
	...
	var req usecase.AddEscalationTargetRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}

	target, err := h.escalationUsecase.AddTarget(c.Request.Context(), ruleID, &req)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
func (h *EscalationHandler) RemoveTarget(c *gin.Context) {
	...
	if err := h.escalationUsecase.RemoveTarget(c.Request.Context(), targetID); err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
