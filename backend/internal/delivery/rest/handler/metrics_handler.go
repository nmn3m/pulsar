...
func (h *MetricsHandler) GetDashboard(c *gin.Context) {
	...
	metrics, err := h.metricsUsecase.GetDashboardMetrics(c.Request.Context(), orgID.(uuid.UUID), filter)
	if err != nil {
...
func (h *MetricsHandler) GetAlertMetrics(c *gin.Context) {
	...
	metrics, err := h.metricsUsecase.GetAlertMetrics(c.Request.Context(), orgID.(uuid.UUID), filter)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *MetricsHandler) GetIncidentMetrics(c *gin.Context) {
	...
	metrics, err := h.metricsUsecase.GetIncidentMetrics(c.Request.Context(), orgID.(uuid.UUID), filter)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *MetricsHandler) GetNotificationMetrics(c *gin.Context) {
	...
	metrics, err := h.metricsUsecase.GetNotificationMetrics(c.Request.Context(), orgID.(uuid.UUID), filter)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *MetricsHandler) GetAlertTrend(c *gin.Context) {
	...
	trend, err := h.metricsUsecase.GetAlertTrend(c.Request.Context(), orgID.(uuid.UUID), filter)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *MetricsHandler) GetTeamMetrics(c *gin.Context) {
	...
	metrics, err := h.metricsUsecase.GetTeamMetrics(c.Request.Context(), orgID.(uuid.UUID), filter)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
