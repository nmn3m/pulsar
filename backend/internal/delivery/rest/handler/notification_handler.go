...
// @Produce      json
// @Security     BearerAuth
// @Param        request body usecase.CreateNotificationChannelRequest true "Channel creation request"
...
func (h *NotificationHandler) CreateChannel(c *gin.Context) {
	...
	var req usecase.CreateNotificationChannelRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}

	channel, err := h.notificationUsecase.CreateChannel(c.Request.Context(), orgID, &req)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
func (h *NotificationHandler) GetChannel(c *gin.Context) {
	...
	channel, err := h.notificationUsecase.GetChannel(c.Request.Context(), id)
	if err != nil {
...
func (h *NotificationHandler) ListChannels(c *gin.Context) {
	...
	channels, err := h.notificationUsecase.ListChannels(c.Request.Context(), orgID)
	if err != nil {
...
// @Security     BearerAuth
// @Param        id path string true "Channel ID" format(uuid)
// @Param        request body usecase.UpdateNotificationChannelRequest true "Channel update request"
// @Success      200 {object} domain.NotificationChannel
// @Failure      400 {object} map[string]string
...
func (h *NotificationHandler) UpdateChannel(c *gin.Context) {
	...
	var req usecase.UpdateNotificationChannelRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}

	channel, err := h.notificationUsecase.UpdateChannel(c.Request.Context(), id, &req)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
func (h *NotificationHandler) DeleteChannel(c *gin.Context) {
	...
	if err := h.notificationUsecase.DeleteChannel(c.Request.Context(), id); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
// @Produce      json
// @Security     BearerAuth
// @Param        request body usecase.CreateUserNotificationPreferenceRequest true "Preference creation request"
...
func (h *NotificationHandler) CreatePreference(c *gin.Context) {
	...
	var req usecase.CreateUserNotificationPreferenceRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}

	pref, err := h.notificationUsecase.CreatePreference(c.Request.Context(), userID, &req)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
func (h *NotificationHandler) GetPreference(c *gin.Context) {
	...
	pref, err := h.notificationUsecase.GetPreference(c.Request.Context(), id)
	if err != nil {
		c.JSON(http.StatusNotFound, gin.H{"error": err.Error()})
		return
	}
...
func (h *NotificationHandler) ListUserPreferences(c *gin.Context) {
	...
	prefs, err := h.notificationUsecase.ListUserPreferences(c.Request.Context(), userID)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
// @Security     BearerAuth
// @Param        id path string true "Preference ID" format(uuid)
// @Param        request body usecase.UpdateUserNotificationPreferenceRequest true "Preference update request"
// @Success      200 {object} domain.UserNotificationPreference
// @Failure      400 {object} map[string]string
...
func (h *NotificationHandler) UpdatePreference(c *gin.Context) {
	...
	var req usecase.UpdateUserNotificationPreferenceRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}

	pref, err := h.notificationUsecase.UpdatePreference(c.Request.Context(), id, &req)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
func (h *NotificationHandler) DeletePreference(c *gin.Context) {
	...
	if err := h.notificationUsecase.DeletePreference(c.Request.Context(), id); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
// @Produce      json
// @Security     BearerAuth
// @Param        request body usecase.SendNotificationRequest true "Notification send request"
...
func (h *NotificationHandler) SendNotification(c *gin.Context) {
	...
	log, err := h.notificationUsecase.SendNotification(c.Request.Context(), orgID, &req)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
func (h *NotificationHandler) GetLog(c *gin.Context) {
	...
	log, err := h.notificationUsecase.GetLog(c.Request.Context(), id)
	if err != nil {
		c.JSON(http.StatusNotFound, gin.H{"error": err.Error()})
		return
	}
...
func (h *NotificationHandler) ListLogs(c *gin.Context) {
	...
	logs, err := h.notificationUsecase.ListLogs(c.Request.Context(), orgID, limit, offset)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *NotificationHandler) ListLogsByAlert(c *gin.Context) {
	...
	logs, err := h.notificationUsecase.ListLogsByAlert(c.Request.Context(), alertID)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
func (h *NotificationHandler) ListLogsByUser(c *gin.Context) {
	...
	logs, err := h.notificationUsecase.ListLogsByUser(c.Request.Context(), userID, limit, offset)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
