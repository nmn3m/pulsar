...
// @Produce      json
// @Security     BearerAuth
// @Param        request body usecase.CreateTeamRequest true "Create team request"
...
func (h *TeamHandler) Create(c *gin.Context) {
	...
	team, err := h.teamUsecase.CreateTeam(c.Request.Context(), orgID, &req)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
// @Success      200 {object} usecase.TeamWithMembers
// @Failure      400 {object} map[string]string
...
func (h *TeamHandler) Get(c *gin.Context) {
	...
	team, err := h.teamUsecase.GetTeamWithMembers(c.Request.Context(), id)
	if err != nil {
...
// @Security     BearerAuth
// @Param        id path string true "Team ID" format(uuid)
// @Param        request body usecase.UpdateTeamRequest true "Update team request"
...
func (h *TeamHandler) Update(c *gin.Context) {
	...
	var req usecase.UpdateTeamRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}

	team, err := h.teamUsecase.UpdateTeam(c.Request.Context(), id, &req)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
func (h *TeamHandler) Delete(c *gin.Context) {
	...
	if err := h.teamUsecase.DeleteTeam(c.Request.Context(), id); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
func (h *TeamHandler) List(c *gin.Context) {
	...
	teams, err := h.teamUsecase.ListTeams(c.Request.Context(), orgID, page, pageSize)
	if err != nil {
...
// @Security     BearerAuth
// @Param        id path string true "Team ID" format(uuid)
// @Param        request body usecase.AddTeamMemberRequest true "Add member request"
// @Success      200 {object} map[string]string
// @Failure      400 {object} map[string]string
...
func (h *TeamHandler) AddMember(c *gin.Context) {
	...
	var req usecase.AddTeamMemberRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}

	if err := h.teamUsecase.AddMember(c.Request.Context(), teamID, &req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
// @Param        id path string true "Team ID" format(uuid)
// @Param        userId path string true "User ID" format(uuid)
// @Param        request body usecase.UpdateTeamMemberRoleRequest true "Update role request"
// @Success      200 {object} map[string]string
// @Failure      400 {object} map[string]string
...
func (h *TeamHandler) UpdateMemberRole(c *gin.Context) {
	...
	var req usecase.UpdateTeamMemberRoleRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}

	if err := h.teamUsecase.UpdateMemberRole(c.Request.Context(), teamID, userID, &req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
func (h *TeamHandler) ListMembers(c *gin.Context) {
	...
	members, err := h.teamUsecase.ListMembers(c.Request.Context(), teamID)
	if err != nil {
		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
		return
	}
...
// @Security     BearerAuth
// @Param        id path string true "Team ID" format(uuid)
// @Param        request body usecase.InviteMemberRequest true "Invite member request"
// @Success      200 {object} usecase.InvitationResponse
// @Failure      400 {object} map[string]string
...
func (h *TeamHandler) InviteMember(c *gin.Context) {
	...
	var req usecase.InviteMemberRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}

	result, err := h.teamUsecase.AddMemberOrInvite(c.Request.Context(), teamID, orgID, userID, &req)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
func (h *TeamHandler) ListInvitations(c *gin.Context) {
	...
	invitations, err := h.teamUsecase.ListTeamInvitations(c.Request.Context(), teamID)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
func (h *TeamHandler) CancelInvitation(c *gin.Context) {
	...
	if err := h.teamUsecase.CancelInvitation(c.Request.Context(), invitationID); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
func (h *TeamHandler) ResendInvitation(c *gin.Context) {
	...
	if err := h.teamUsecase.ResendInvitation(c.Request.Context(), invitationID); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
