...
// @Produce      json
// @Security     BearerAuth
// @Param        request body usecase.CreateWebhookEndpointRequest true "Create endpoint request"
...
func (h *WebhookHandler) CreateEndpoint(c *gin.Context) {
	...
	var req usecase.CreateWebhookEndpointRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}

	endpoint, err := h.webhookUsecase.CreateEndpoint(c.Request.Context(), orgID, &req)
	if err != nil {
...
func (h *WebhookHandler) GetEndpoint(c *gin.Context) {
	...
	endpoint, err := h.webhookUsecase.GetEndpoint(c.Request.Context(), id)
	if err != nil {
...
func (h *WebhookHandler) ListEndpoints(c *gin.Context) {
	...
	endpoints, err := h.webhookUsecase.ListEndpoints(c.Request.Context(), orgID)
	if err != nil {
...
// @Security     BearerAuth
// @Param        id path string true "Endpoint ID" format(uuid)
// @Param        request body usecase.UpdateWebhookEndpointRequest true "Update endpoint request"
// @Success      200 {object} domain.WebhookEndpoint
// @Failure      400 {object} map[string]string
// @Failure      404 {object} map[string]string
// @Failure      500 {object} map[string]string
...
func (h *WebhookHandler) UpdateEndpoint(c *gin.Context) {
	...
	var req usecase.UpdateWebhookEndpointRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}

	endpoint, err := h.webhookUsecase.UpdateEndpoint(c.Request.Context(), id, orgID, &req)
	if err != nil {
		if err == domain.ErrNotFound {
			c.JSON(http.StatusNotFound, gin.H{"error": "Webhook endpoint not found"})
			return
...
func (h *WebhookHandler) DeleteEndpoint(c *gin.Context) {
	...
	if err := h.webhookUsecase.DeleteEndpoint(c.Request.Context(), id, orgID); err != nil {
		if err == domain.ErrNotFound {
			c.JSON(http.StatusNotFound, gin.H{"error": "Webhook endpoint not found"})
			return
		}
...
func (h *WebhookHandler) ListDeliveries(c *gin.Context) {
	...
	deliveries, err := h.webhookUsecase.ListDeliveries(c.Request.Context(), orgID, limit, offset)
	if err != nil {
...
// @Produce      json
// @Security     BearerAuth
// @Param        request body usecase.CreateIncomingWebhookTokenRequest true "Create token request"
...
func (h *WebhookHandler) CreateIncomingToken(c *gin.Context) {
	...
	var req usecase.CreateIncomingWebhookTokenRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}

	token, err := h.webhookUsecase.CreateIncomingToken(c.Request.Context(), orgID, &req)
	if err != nil {
...
func (h *WebhookHandler) ListIncomingTokens(c *gin.Context) {
	...
	tokens, err := h.webhookUsecase.ListIncomingTokens(c.Request.Context(), orgID)
	if err != nil {
...
func (h *WebhookHandler) DeleteIncomingToken(c *gin.Context) {
	...
	if err := h.webhookUsecase.DeleteIncomingToken(c.Request.Context(), id, orgID); err != nil {
		if err == domain.ErrNotFound {
