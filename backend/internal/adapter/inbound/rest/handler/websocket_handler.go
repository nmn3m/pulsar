...
type WebSocketHandler struct {
	wsService inbound.WebSocketService
	logger    *zap.Logger
	upgrader  websocket.Upgrader
}

func NewWebSocketHandler(wsService inbound.WebSocketService, logger *zap.Logger, allowedOrigins []string) *WebSocketHandler {
