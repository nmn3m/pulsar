...
type DNDHandler struct {
	dndService inbound.DNDService
}

func NewDNDHandler(dndService inbound.DNDService) *DNDHandler {
...
// @Accept json
// @Produce json
// @Param request body dto.UpdateDNDSettingsRequest true "DND settings"
// @Success 200 {object} domain.UserDNDSettings
...
func (h *DNDHandler) UpdateDNDSettings(c *gin.Context) {
	...
	var req dto.UpdateDNDSettingsRequest
...
// @Accept json
// @Produce json
// @Param request body dto.AddDNDOverrideRequest true "Override details"
// @Success 200 {object} domain.UserDNDSettings
// @Failure 400 {object} map[string]string
// @Failure 401 {object} map[string]string
// @Failure 500 {object} map[string]string
...
func (h *DNDHandler) AddDNDOverride(c *gin.Context) {
	...
	var req dto.AddDNDOverrideRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
