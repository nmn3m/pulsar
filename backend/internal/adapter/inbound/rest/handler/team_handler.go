...
type TeamHandler struct {
	teamService inbound.TeamService
}

func NewTeamHandler(teamService inbound.TeamService) *TeamHandler {
	return &TeamHandler{
...
// @Produce      json
// @Security     BearerAuth
// @Param        request body dto.CreateTeamRequest true "Create team request"
...
// @Success      200 {object} dto.TeamWithMembers
// @Failure      400 {object} map[string]string
...
// @Security     BearerAuth
// @Param        id path string true "Team ID" format(uuid)
// @Param        request body dto.AddTeamMemberRequest true "Add member request"
// @Success      200 {object} map[string]string
// @Failure      400 {object} map[string]string
...
// @Security     BearerAuth
// @Param        id path string true "Team ID" format(uuid)
// @Param        request body dto.InviteMemberRequest true "Invite member request"
