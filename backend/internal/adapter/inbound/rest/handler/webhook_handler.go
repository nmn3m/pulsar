...
func NewWebhookHandler(webhookService inbound.WebhookService) *WebhookHandler {
...
// @Produce      json
// @Security     BearerAuth
// @Param        request body dto.CreateWebhookEndpointRequest true "Create endpoint request"
...
// @Security     BearerAuth
// @Param        id path string true "Endpoint ID" format(uuid)
// @Param        request body dto.UpdateWebhookEndpointRequest true "Update endpoint request"
// @Success      200 {object} domain.WebhookEndpoint
// @Failure      400 {object} map[string]string
// @Failure      404 {object} map[string]string
// @Failure      500 {object} map[string]string
...
// @Produce      json
// @Security     BearerAuth
// @Param        request body dto.CreateIncomingWebhookTokenRequest true "Create token request"
...
func (h *WebhookHandler) CreateIncomingToken(c *gin.Context) {
	...
	var req dto.CreateIncomingWebhookTokenRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
