...
type EscalationHandler struct {
	escalationService inbound.EscalationService
}

func NewEscalationHandler(escalationService inbound.EscalationService) *EscalationHandler {
...
// @Produce      json
// @Security     BearerAuth
// @Param        request  body      dto.CreateEscalationPolicyRequest  true  "Escalation policy creation request"
...
// @Security     BearerAuth
// @Param        id       path      string                                 true  "Escalation policy ID"  format(uuid)
// @Param        request  body      dto.UpdateEscalationPolicyRequest  true  "Escalation policy update request"
...
// @Security     BearerAuth
// @Param        id       path      string                               true  "Escalation policy ID"  format(uuid)
// @Param        request  body      dto.CreateEscalationRuleRequest  true  "Escalation rule creation request"
...
// @Param        id       path      string                               true  "Escalation policy ID"  format(uuid)
// @Param        ruleId   path      string                               true  "Escalation rule ID"    format(uuid)
// @Param        request  body      dto.UpdateEscalationRuleRequest  true  "Escalation rule update request"
...
func (h *EscalationHandler) UpdateRule(c *gin.Context) {
	...
	var req dto.UpdateEscalationRuleRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
// @Param        id       path      string                              true  "Escalation policy ID"  format(uuid)
// @Param        ruleId   path      string                              true  "Escalation rule ID"    format(uuid)
// @Param        request  body      dto.AddEscalationTargetRequest  true  "Escalation target request"
...
func (h *EscalationHandler) AddTarget(c *gin.Context) {
	...
	var req dto.AddEscalationTargetRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
