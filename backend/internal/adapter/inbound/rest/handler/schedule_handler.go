...
type ScheduleHandler struct {
	scheduleService inbound.ScheduleService
}

func NewScheduleHandler(scheduleService inbound.ScheduleService) *ScheduleHandler {
...
// @Security     BearerAuth
// @Param        id       path      string                          true  "Schedule ID"  format(uuid)
// @Param        request  body      dto.CreateRotationRequest   true  "Rotation creation request"
...
func (h *ScheduleHandler) CreateRotation(c *gin.Context) {
	...
	var req dto.CreateRotationRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
// @Param        id          path      string                          true  "Schedule ID"   format(uuid)
// @Param        rotationId  path      string                          true  "Rotation ID"   format(uuid)
// @Param        request     body      dto.UpdateRotationRequest   true  "Rotation update request"
// @Success      200         {object}  domain.ScheduleRotation
// @Failure      400         {object}  map[string]string
...
func (h *ScheduleHandler) UpdateRotation(c *gin.Context) {
	...
	var req dto.UpdateRotationRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
// @Param        id          path      string                              true  "Schedule ID"   format(uuid)
// @Param        rotationId  path      string                              true  "Rotation ID"   format(uuid)
// @Param        request     body      dto.ReorderParticipantsRequest  true  "Reorder participants request"
// @Success      200         {object}  map[string]string
// @Failure      400         {object}  map[string]string
...
func (h *ScheduleHandler) ReorderParticipants(c *gin.Context) {
	...
	var req dto.ReorderParticipantsRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
// @Security     BearerAuth
// @Param        id       path      string                          true  "Schedule ID"  format(uuid)
// @Param        request  body      dto.CreateOverrideRequest   true  "Override creation request"
...
// @Param        id          path      string                          true  "Schedule ID"   format(uuid)
// @Param        overrideId  path      string                          true  "Override ID"   format(uuid)
// @Param        request     body      dto.UpdateOverrideRequest   true  "Override update request"
// @Success      200         {object}  domain.ScheduleOverride
// @Failure      400         {object}  map[string]string
