...
func NewNotificationHandler(notificationService inbound.NotificationService) *NotificationHandler {
...
// @Produce      json
// @Security     BearerAuth
// @Param        request body dto.CreateNotificationChannelRequest true "Channel creation request"
...
// @Security     BearerAuth
// @Param        id path string true "Channel ID" format(uuid)
// @Param        request body dto.UpdateNotificationChannelRequest true "Channel update request"
// @Success      200 {object} domain.NotificationChannel
// @Failure      400 {object} map[string]string
...
// @Produce      json
// @Security     BearerAuth
// @Param        request body dto.CreateUserNotificationPreferenceRequest true "Preference creation request"
...
func (h *NotificationHandler) CreatePreference(c *gin.Context) {
	...
	var req dto.CreateUserNotificationPreferenceRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
// @Security     BearerAuth
// @Param        id path string true "Preference ID" format(uuid)
// @Param        request body dto.UpdateUserNotificationPreferenceRequest true "Preference update request"
// @Success      200 {object} domain.UserNotificationPreference
// @Failure      400 {object} map[string]string
...
func (h *NotificationHandler) UpdatePreference(c *gin.Context) {
	...
	var req dto.UpdateUserNotificationPreferenceRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
...
// @Produce      json
// @Security     BearerAuth
// @Param        request body dto.SendNotificationRequest true "Notification send request"
