...
func (s *EscalationUsecase) CreatePolicy(ctx context.Context, orgID uuid.UUID, req *CreateEscalationPolicyRequest) (*domain.EscalationPolicy, error) {
...
func (s *EscalationUsecase) GetPolicy(ctx context.Context, id uuid.UUID) (*domain.EscalationPolicy, error) {
...
func (s *EscalationUsecase) GetPolicyWithRules(ctx context.Context, id uuid.UUID) (*domain.EscalationPolicyWithRules, error) {
...
func (s *EscalationUsecase) UpdatePolicy(ctx context.Context, id uuid.UUID, req *UpdateEscalationPolicyRequest) (*domain.EscalationPolicy, error) {
	policy, err := s.escalationRepo.GetByID(ctx, id)
	if err != nil {
		return nil, fmt.Errorf("failed to get escalation policy: %w", err)
	}
...
func (s *EscalationUsecase) DeletePolicy(ctx context.Context, id uuid.UUID) error {
...
func (s *EscalationUsecase) ListPolicies(ctx context.Context, orgID uuid.UUID, page, pageSize int) ([]*domain.EscalationPolicy, error) {
	if page < 1 {
		page = 1
	}
...
func (s *EscalationUsecase) CreateRule(ctx context.Context, policyID uuid.UUID, req *CreateEscalationRuleRequest) (*domain.EscalationRule, error) {
...
func (s *EscalationUsecase) GetRule(ctx context.Context, id uuid.UUID) (*domain.EscalationRule, error) {
...
func (s *EscalationUsecase) UpdateRule(ctx context.Context, id uuid.UUID, req *UpdateEscalationRuleRequest) (*domain.EscalationRule, error) {
	rule, err := s.escalationRepo.GetRule(ctx, id)
	if err != nil {
		return nil, fmt.Errorf("failed to get escalation rule: %w", err)
	}
...
func (s *EscalationUsecase) DeleteRule(ctx context.Context, id uuid.UUID) error {
...
func (s *EscalationUsecase) ListRules(ctx context.Context, policyID uuid.UUID) ([]*domain.EscalationRule, error) {
...
func (s *EscalationUsecase) AddTarget(ctx context.Context, ruleID uuid.UUID, req *AddEscalationTargetRequest) (*domain.EscalationTarget, error) {
...
func (s *EscalationUsecase) RemoveTarget(ctx context.Context, id uuid.UUID) error {
...
func (s *EscalationUsecase) ListTargets(ctx context.Context, ruleID uuid.UUID) ([]*domain.EscalationTarget, error) {
...
func (s *EscalationUsecase) ProcessPendingEscalations(ctx context.Context) error {
...
func (s *EscalationUsecase) processEscalation(ctx context.Context, event *domain.AlertEscalationEvent) error {
...
func (s *EscalationUsecase) StopEscalation(ctx context.Context, alertID uuid.UUID) error {
