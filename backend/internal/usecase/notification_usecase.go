...
import (
	...
	"github.com/nmn3m/pulsar/backend/internal/usecase/providers"
...
func (s *NotificationUsecase) createProviderFromChannel(channel *domain.NotificationChannel) (NotificationProvider, error) {
...
func (s *NotificationUsecase) validateChannelConfig(channelType domain.ChannelType, config json.RawMessage) error {
	switch channelType {
	case domain.ChannelTypeEmail:
...
func (s *NotificationUsecase) CreateChannel(ctx context.Context, orgID uuid.UUID, req *CreateNotificationChannelRequest) (*domain.NotificationChannel, error) {
...
func (s *NotificationUsecase) GetChannel(ctx context.Context, id uuid.UUID) (*domain.NotificationChannel, error) {
	return s.repo.GetChannelByID(ctx, id)
}

func (s *NotificationUsecase) ListChannels(ctx context.Context, orgID uuid.UUID) ([]domain.NotificationChannel, error) {
	return s.repo.ListChannels(ctx, orgID)
}

func (s *NotificationUsecase) UpdateChannel(ctx context.Context, id uuid.UUID, req *UpdateNotificationChannelRequest) (*domain.NotificationChannel, error) {
...
func (s *NotificationUsecase) DeleteChannel(ctx context.Context, id uuid.UUID) error {
	return s.repo.DeleteChannel(ctx, id)
}

// ==================== User Preference Management ====================

func (s *NotificationUsecase) CreatePreference(ctx context.Context, userID uuid.UUID, req *CreateUserNotificationPreferenceRequest) (*domain.UserNotificationPreference, error) {
...
func (s *NotificationUsecase) GetPreference(ctx context.Context, id uuid.UUID) (*domain.UserNotificationPreference, error) {
	return s.repo.GetPreferenceByID(ctx, id)
}

func (s *NotificationUsecase) ListUserPreferences(ctx context.Context, userID uuid.UUID) ([]domain.UserNotificationPreference, error) {
	return s.repo.ListPreferencesByUser(ctx, userID)
}

func (s *NotificationUsecase) UpdatePreference(ctx context.Context, id uuid.UUID, req *UpdateUserNotificationPreferenceRequest) (*domain.UserNotificationPreference, error) {
...
func (s *NotificationUsecase) DeletePreference(ctx context.Context, id uuid.UUID) error {
	return s.repo.DeletePreference(ctx, id)
}

// ==================== Notification Sending ====================

func (s *NotificationUsecase) SendNotification(ctx context.Context, orgID uuid.UUID, req *SendNotificationRequest) (*domain.NotificationLog, error) {
	// Get the channel
...
func (s *NotificationUsecase) ProcessPendingNotifications(ctx context.Context, limit int) error {
...
func (s *NotificationUsecase) GetLog(ctx context.Context, id uuid.UUID) (*domain.NotificationLog, error) {
	return s.repo.GetLogByID(ctx, id)
}

func (s *NotificationUsecase) ListLogs(ctx context.Context, orgID uuid.UUID, limit, offset int) ([]domain.NotificationLog, error) {
	if limit <= 0 {
		limit = 50
	}
...
func (s *NotificationUsecase) ListLogsByAlert(ctx context.Context, alertID uuid.UUID) ([]domain.NotificationLog, error) {
	return s.repo.ListLogsByAlert(ctx, alertID)
}

func (s *NotificationUsecase) ListLogsByUser(ctx context.Context, userID uuid.UUID, limit, offset int) ([]domain.NotificationLog, error) {
	if limit <= 0 {
		limit = 50
	}
...
// UnmarshalChannelConfig is a helper function to unmarshal channel config into a specific struct
