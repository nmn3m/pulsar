...
func NewWebhookUsecase(webhookRepo repository.WebhookRepository, logger *zap.Logger) *WebhookUsecase {
...
func (s *WebhookUsecase) GetEndpoint(ctx context.Context, id uuid.UUID) (*domain.WebhookEndpoint, error) {
	return s.webhookRepo.GetEndpointByID(ctx, id)
}

func (s *WebhookUsecase) ListEndpoints(ctx context.Context, orgID uuid.UUID) ([]*domain.WebhookEndpoint, error) {
	return s.webhookRepo.ListEndpoints(ctx, orgID)
}

func (s *WebhookUsecase) UpdateEndpoint(ctx context.Context, id, orgID uuid.UUID, req *UpdateWebhookEndpointRequest) (*domain.WebhookEndpoint, error) {
...
func (s *WebhookUsecase) DeleteEndpoint(ctx context.Context, id, orgID uuid.UUID) error {
	return s.webhookRepo.DeleteEndpoint(ctx, id, orgID)
}

// Webhook Delivery

func (s *WebhookUsecase) TriggerWebhooks(ctx context.Context, orgID uuid.UUID, eventType string, data map[string]interface{}) {
...
func (s *WebhookUsecase) deliverWebhook(ctx context.Context, endpoint *domain.WebhookEndpoint, delivery *domain.WebhookDelivery, payload *domain.WebhookPayload) {
	delivery.Attempts++
	now := time.Now()
...
func (s *WebhookUsecase) handleDeliveryError(ctx context.Context, endpoint *domain.WebhookEndpoint, delivery *domain.WebhookDelivery, errMsg string) {
...
func (s *WebhookUsecase) markDeliveryFailed(ctx context.Context, delivery *domain.WebhookDelivery, errMsg string) {
...
func (s *WebhookUsecase) ProcessPendingDeliveries(ctx context.Context) error {
...
func (s *WebhookUsecase) ListDeliveries(ctx context.Context, orgID uuid.UUID, limit, offset int) ([]*domain.WebhookDelivery, error) {
...
func (s *WebhookUsecase) CreateIncomingToken(ctx context.Context, orgID uuid.UUID, req *CreateIncomingWebhookTokenRequest) (*domain.IncomingWebhookToken, error) {
	...
	token := &domain.IncomingWebhookToken{
		...
		Token:           tokenStr,
		Enabled:         true,
		IntegrationType: domain.IncomingWebhookIntegrationType(req.IntegrationType),
...
func (s *WebhookUsecase) GetIncomingTokenByToken(ctx context.Context, token string) (*domain.IncomingWebhookToken, error) {
	return s.webhookRepo.GetIncomingTokenByToken(ctx, token)
}

func (s *WebhookUsecase) ListIncomingTokens(ctx context.Context, orgID uuid.UUID) ([]*domain.IncomingWebhookToken, error) {
	return s.webhookRepo.ListIncomingTokens(ctx, orgID)
}

func (s *WebhookUsecase) UpdateIncomingTokenUsage(ctx context.Context, tokenID uuid.UUID) error {
	return s.webhookRepo.UpdateIncomingTokenUsage(ctx, tokenID)
}

func (s *WebhookUsecase) DeleteIncomingToken(ctx context.Context, id, orgID uuid.UUID) error {
