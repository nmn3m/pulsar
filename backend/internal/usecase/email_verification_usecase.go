...
func (s *EmailVerificationUsecase) IsEmailServiceConfigured() bool {
	return s.emailService != nil && s.emailService.IsConfigured()
}

// GenerateOTP generates a random 6-digit OTP
func (s *EmailVerificationUsecase) GenerateOTP() (string, error) {
...
func (s *EmailVerificationUsecase) CreateAndSendOTP(ctx context.Context, userID uuid.UUID, email, username string) error {
	// Generate OTP
...
func (s *EmailVerificationUsecase) VerifyOTP(ctx context.Context, email, otp string) error {
...
func (s *EmailVerificationUsecase) ResendOTP(ctx context.Context, email string) error {
	// Get user by email
...
func (s *EmailVerificationUsecase) GetPendingVerification(ctx context.Context, userID uuid.UUID) (*domain.EmailVerification, error) {
	return s.verificationRepo.GetByUserID(ctx, userID)
}

// CleanupExpired removes expired verification records
func (s *EmailVerificationUsecase) CleanupExpired(ctx context.Context) error {
