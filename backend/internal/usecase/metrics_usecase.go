...
func NewMetricsUsecase(metricsRepo repository.MetricsRepository) *MetricsUsecase {
...
func (s *MetricsUsecase) GetDashboardMetrics(ctx context.Context, orgID uuid.UUID, filter *domain.MetricsFilter) (*domain.DashboardMetrics, error) {
...
func (s *MetricsUsecase) GetAlertMetrics(ctx context.Context, orgID uuid.UUID, filter *domain.MetricsFilter) (*domain.AlertMetrics, error) {
	return s.metricsRepo.GetAlertMetrics(ctx, orgID, filter)
}

// GetIncidentMetrics returns incident-specific metrics
func (s *MetricsUsecase) GetIncidentMetrics(ctx context.Context, orgID uuid.UUID, filter *domain.MetricsFilter) (*domain.IncidentMetrics, error) {
	return s.metricsRepo.GetIncidentMetrics(ctx, orgID, filter)
}

// GetNotificationMetrics returns notification-specific metrics
func (s *MetricsUsecase) GetNotificationMetrics(ctx context.Context, orgID uuid.UUID, filter *domain.MetricsFilter) (*domain.NotificationMetrics, error) {
	return s.metricsRepo.GetNotificationMetrics(ctx, orgID, filter)
}

// GetAlertTrend returns time-series data for alerts
func (s *MetricsUsecase) GetAlertTrend(ctx context.Context, orgID uuid.UUID, filter *domain.MetricsFilter) (*domain.AlertTrend, error) {
	return s.metricsRepo.GetAlertTrend(ctx, orgID, filter)
}

// GetTeamMetrics returns team performance metrics
func (s *MetricsUsecase) GetTeamMetrics(ctx context.Context, orgID uuid.UUID, filter *domain.MetricsFilter) ([]domain.TeamMetrics, error) {
