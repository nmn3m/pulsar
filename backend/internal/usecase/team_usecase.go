...
func (s *TeamUsecase) SetInvitationRepo(repo repository.TeamInvitationRepository) {
	s.invitationRepo = repo
}

// SetEmailService sets the email service (optional dependency)
func (s *TeamUsecase) SetEmailService(emailSvc EmailServiceInterface) {
...
func (s *TeamUsecase) CreateTeam(ctx context.Context, orgID uuid.UUID, req *CreateTeamRequest) (*domain.Team, error) {
	team := &domain.Team{
		ID:             uuid.New(),
...
func (s *TeamUsecase) GetTeam(ctx context.Context, id uuid.UUID) (*domain.Team, error) {
...
func (s *TeamUsecase) GetTeamWithMembers(ctx context.Context, id uuid.UUID) (*TeamWithMembers, error) {
	team, err := s.teamRepo.GetByID(ctx, id)
	if err != nil {
		return nil, fmt.Errorf("failed to get team: %w", err)
	}
...
func (s *TeamUsecase) UpdateTeam(ctx context.Context, id uuid.UUID, req *UpdateTeamRequest) (*domain.Team, error) {
	team, err := s.teamRepo.GetByID(ctx, id)
	if err != nil {
		return nil, fmt.Errorf("failed to get team: %w", err)
	}
...
func (s *TeamUsecase) DeleteTeam(ctx context.Context, id uuid.UUID) error {
...
func (s *TeamUsecase) ListTeams(ctx context.Context, orgID uuid.UUID, page, pageSize int) ([]*domain.Team, error) {
	if page < 1 {
		page = 1
	}
...
func (s *TeamUsecase) AddMember(ctx context.Context, teamID uuid.UUID, req *AddTeamMemberRequest) error {
	// Parse role
...
func (s *TeamUsecase) AddMemberOrInvite(ctx context.Context, teamID, orgID, inviterID uuid.UUID, req *InviteMemberRequest) (*InvitationResponse, error) {
	// Parse role
	role := domain.TeamRoleMember
	if req.Role != "" {
		role = domain.TeamRole(req.Role)
...
func (s *TeamUsecase) AcceptInvitation(ctx context.Context, token string, userID uuid.UUID) error {
	if s.invitationRepo == nil {
...
func (s *TeamUsecase) DeclineInvitation(ctx context.Context, token string) error {
	if s.invitationRepo == nil {
		return fmt.Errorf("invitation feature not configured")
	}
...
func (s *TeamUsecase) GetPendingInvitations(ctx context.Context, email string) ([]*domain.TeamInvitationWithDetails, error) {
	if s.invitationRepo == nil {
		return nil, fmt.Errorf("invitation feature not configured")
	}
...
func (s *TeamUsecase) ListTeamInvitations(ctx context.Context, teamID uuid.UUID) ([]*domain.TeamInvitation, error) {
	if s.invitationRepo == nil {
		return nil, fmt.Errorf("invitation feature not configured")
	}
...
func (s *TeamUsecase) CancelInvitation(ctx context.Context, invitationID uuid.UUID) error {
	if s.invitationRepo == nil {
		return fmt.Errorf("invitation feature not configured")
	}
...
func (s *TeamUsecase) ResendInvitation(ctx context.Context, invitationID uuid.UUID) error {
	if s.invitationRepo == nil {
		return fmt.Errorf("invitation feature not configured")
	}
...
func (s *TeamUsecase) RemoveMember(ctx context.Context, teamID, userID uuid.UUID) error {
...
func (s *TeamUsecase) UpdateMemberRole(ctx context.Context, teamID, userID uuid.UUID, req *UpdateTeamMemberRoleRequest) error {
	role := domain.TeamRole(req.Role)
...
func (s *TeamUsecase) ListMembers(ctx context.Context, teamID uuid.UUID) ([]*domain.UserWithTeamRole, error) {
...
func (s *TeamUsecase) ListUserTeams(ctx context.Context, userID uuid.UUID) ([]*domain.Team, error) {
