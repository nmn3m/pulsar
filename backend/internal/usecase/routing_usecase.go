...
func NewRoutingUsecase(routingRepo repository.RoutingRuleRepository) *RoutingUsecase {
...
func (s *RoutingUsecase) CreateRule(ctx context.Context, orgID uuid.UUID, req *CreateRoutingRuleRequest) (*domain.AlertRoutingRule, error) {
...
func (s *RoutingUsecase) GetRule(ctx context.Context, id uuid.UUID) (*domain.AlertRoutingRule, error) {
	return s.routingRepo.GetByID(ctx, id)
}

// UpdateRule updates an existing routing rule
func (s *RoutingUsecase) UpdateRule(ctx context.Context, id uuid.UUID, req *UpdateRoutingRuleRequest) (*domain.AlertRoutingRule, error) {
...
func (s *RoutingUsecase) DeleteRule(ctx context.Context, id uuid.UUID) error {
	return s.routingRepo.Delete(ctx, id)
}

// ListRules lists routing rules for an organization
func (s *RoutingUsecase) ListRules(ctx context.Context, orgID uuid.UUID, page, pageSize int) ([]*domain.AlertRoutingRule, error) {
	if page < 1 {
		page = 1
	}
	if pageSize < 1 {
...
func (s *RoutingUsecase) ReorderRules(ctx context.Context, orgID uuid.UUID, req *ReorderRoutingRulesRequest) error {
...
func (s *RoutingUsecase) ApplyRouting(ctx context.Context, orgID uuid.UUID, alert *domain.Alert) (*domain.RoutingActions, error) {
...
func (s *RoutingUsecase) evaluateConditions(alert *domain.Alert, conditions *domain.RoutingConditions) bool {
...
func (s *RoutingUsecase) evaluateCondition(alert *domain.Alert, condition *domain.RoutingCondition) bool {
...
func (s *RoutingUsecase) evaluateTagsCondition(tags []string, condition *domain.RoutingCondition) bool {
...
func (s *RoutingUsecase) evaluateOperator(fieldValue, operator, conditionValue string) bool {
	switch operator {
	case "equals":
