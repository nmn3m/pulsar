...
func (s *ScheduleUsecase) CreateSchedule(ctx context.Context, orgID uuid.UUID, req *CreateScheduleRequest) (*domain.Schedule, error) {
...
func (s *ScheduleUsecase) GetSchedule(ctx context.Context, id uuid.UUID) (*domain.Schedule, error) {
...
func (s *ScheduleUsecase) GetScheduleWithRotations(ctx context.Context, id uuid.UUID) (*domain.ScheduleWithRotations, error) {
...
func (s *ScheduleUsecase) UpdateSchedule(ctx context.Context, id uuid.UUID, req *UpdateScheduleRequest) (*domain.Schedule, error) {
	schedule, err := s.scheduleRepo.GetByID(ctx, id)
	if err != nil {
		return nil, fmt.Errorf("failed to get schedule: %w", err)
	}
...
func (s *ScheduleUsecase) DeleteSchedule(ctx context.Context, id uuid.UUID) error {
...
func (s *ScheduleUsecase) ListSchedules(ctx context.Context, orgID uuid.UUID, page, pageSize int) ([]*domain.Schedule, error) {
	if page < 1 {
		page = 1
	}
...
func (s *ScheduleUsecase) CreateRotation(ctx context.Context, scheduleID uuid.UUID, req *CreateRotationRequest) (*domain.ScheduleRotation, error) {
...
func (s *ScheduleUsecase) GetRotation(ctx context.Context, id uuid.UUID) (*domain.ScheduleRotation, error) {
...
func (s *ScheduleUsecase) UpdateRotation(ctx context.Context, id uuid.UUID, req *UpdateRotationRequest) (*domain.ScheduleRotation, error) {
	rotation, err := s.scheduleRepo.GetRotation(ctx, id)
	if err != nil {
		return nil, fmt.Errorf("failed to get rotation: %w", err)
	}
...
func (s *ScheduleUsecase) DeleteRotation(ctx context.Context, id uuid.UUID) error {
...
func (s *ScheduleUsecase) ListRotations(ctx context.Context, scheduleID uuid.UUID) ([]*domain.ScheduleRotation, error) {
...
func (s *ScheduleUsecase) AddParticipant(ctx context.Context, rotationID uuid.UUID, req *AddParticipantRequest) (*domain.ScheduleRotationParticipant, error) {
	// Verify user exists
...
func (s *ScheduleUsecase) RemoveParticipant(ctx context.Context, rotationID, userID uuid.UUID) error {
...
func (s *ScheduleUsecase) ListParticipants(ctx context.Context, rotationID uuid.UUID) ([]*domain.ParticipantWithUser, error) {
...
func (s *ScheduleUsecase) ReorderParticipants(ctx context.Context, rotationID uuid.UUID, req *ReorderParticipantsRequest) error {
...
func (s *ScheduleUsecase) CreateOverride(ctx context.Context, scheduleID uuid.UUID, req *CreateOverrideRequest) (*domain.ScheduleOverride, error) {
	// Verify user exists
	_, err := s.userRepo.GetByID(ctx, req.UserID)
	if err != nil {
		return nil, fmt.Errorf("user not found")
...
func (s *ScheduleUsecase) GetOverride(ctx context.Context, id uuid.UUID) (*domain.ScheduleOverride, error) {
...
func (s *ScheduleUsecase) UpdateOverride(ctx context.Context, id uuid.UUID, req *UpdateOverrideRequest) (*domain.ScheduleOverride, error) {
	override, err := s.scheduleRepo.GetOverride(ctx, id)
	if err != nil {
		return nil, fmt.Errorf("failed to get override: %w", err)
	}
...
func (s *ScheduleUsecase) DeleteOverride(ctx context.Context, id uuid.UUID) error {
...
func (s *ScheduleUsecase) ListOverrides(ctx context.Context, scheduleID uuid.UUID, start, end time.Time) ([]*domain.ScheduleOverride, error) {
...
func (s *ScheduleUsecase) GetOnCallUser(ctx context.Context, scheduleID uuid.UUID, at time.Time) (*domain.OnCallUser, error) {
...
func (s *ScheduleUsecase) calculateOnCallFromRotation(
	rotation *domain.ScheduleRotation,
