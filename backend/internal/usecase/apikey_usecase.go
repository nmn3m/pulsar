...
func (s *APIKeyUsecase) CreateAPIKey(ctx context.Context, orgID, userID uuid.UUID, req *CreateAPIKeyRequest) (*APIKeyResponse, error) {
	// Validate scopes
...
func (s *APIKeyUsecase) ValidateAPIKey(ctx context.Context, rawKey string) (*domain.APIKey, error) {
...
func (s *APIKeyUsecase) GetAPIKey(ctx context.Context, id uuid.UUID) (*domain.APIKey, error) {
	return s.repo.GetByID(ctx, id)
}

// ListAPIKeys lists all API keys for an organization
func (s *APIKeyUsecase) ListAPIKeys(ctx context.Context, orgID uuid.UUID) ([]domain.APIKey, error) {
	return s.repo.ListByOrganization(ctx, orgID)
}

// ListUserAPIKeys lists all API keys for a user
func (s *APIKeyUsecase) ListUserAPIKeys(ctx context.Context, userID uuid.UUID) ([]domain.APIKey, error) {
	return s.repo.ListByUser(ctx, userID)
}

// UpdateAPIKey updates an API key
func (s *APIKeyUsecase) UpdateAPIKey(ctx context.Context, id uuid.UUID, req *UpdateAPIKeyRequest) (*domain.APIKey, error) {
...
func (s *APIKeyUsecase) RevokeAPIKey(ctx context.Context, id uuid.UUID) error {
	key, err := s.repo.GetByID(ctx, id)
	if err != nil {
		return err
	}
...
func (s *APIKeyUsecase) DeleteAPIKey(ctx context.Context, id uuid.UUID) error {
	return s.repo.Delete(ctx, id)
}

// RevokeAllUserAPIKeys revokes all API keys for a user
func (s *APIKeyUsecase) RevokeAllUserAPIKeys(ctx context.Context, userID uuid.UUID) error {
	return s.repo.RevokeAllByUser(ctx, userID)
}

// CheckScope checks if an API key has a specific scope
func (s *APIKeyUsecase) CheckScope(key *domain.APIKey, scope domain.APIKeyScope) bool {
