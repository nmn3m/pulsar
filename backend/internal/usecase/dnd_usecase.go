...
type DNDUsecase struct {
	dndRepo repository.DNDSettingsRepository
}

func NewDNDUsecase(dndRepo repository.DNDSettingsRepository) *DNDUsecase {
	return &DNDUsecase{dndRepo: dndRepo}
}

// GetSettings retrieves DND settings for a user
func (s *DNDUsecase) GetSettings(ctx context.Context, userID uuid.UUID) (*domain.UserDNDSettings, error) {
...
func (s *DNDUsecase) UpdateSettings(ctx context.Context, userID uuid.UUID, req *UpdateDNDSettingsRequest) (*domain.UserDNDSettings, error) {
...
func (s *DNDUsecase) AddOverride(ctx context.Context, userID uuid.UUID, req *AddDNDOverrideRequest) (*domain.UserDNDSettings, error) {
	settings, err := s.dndRepo.GetByUserID(ctx, userID)
	if err != nil {
		return nil, fmt.Errorf("failed to get DND settings: %w", err)
	}
...
func (s *DNDUsecase) RemoveOverride(ctx context.Context, userID uuid.UUID, index int) (*domain.UserDNDSettings, error) {
	settings, err := s.dndRepo.GetByUserID(ctx, userID)
	if err != nil {
		return nil, fmt.Errorf("failed to get DND settings: %w", err)
	}
...
func (s *DNDUsecase) IsInDNDMode(ctx context.Context, userID uuid.UUID, priority domain.AlertPriority) (bool, error) {
	settings, err := s.dndRepo.GetByUserID(ctx, userID)
	if err != nil {
...
func (s *DNDUsecase) CleanExpiredOverrides(ctx context.Context, userID uuid.UUID) error {
	settings, err := s.dndRepo.GetByUserID(ctx, userID)
	if err != nil {
...
func (s *DNDUsecase) DeleteSettings(ctx context.Context, userID uuid.UUID) error {
