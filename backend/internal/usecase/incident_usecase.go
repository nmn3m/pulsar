...
func NewIncidentUsecase(incidentRepo repository.IncidentRepository, wsUsecase *WebSocketUsecase) *IncidentUsecase {
...
func (s *IncidentUsecase) CreateIncident(ctx context.Context, orgID, userID uuid.UUID, req *CreateIncidentRequest) (*domain.Incident, error) {
	// Validate severity
	...
	if s.wsUsecase != nil {
		s.wsUsecase.BroadcastIncidentEvent(domain.WSEventIncidentCreated, orgID, incident)
		s.wsUsecase.BroadcastIncidentTimelineEvent(orgID, incident.ID, timelineEvent)
	}
...
func (s *IncidentUsecase) UpdateIncident(ctx context.Context, id, userID uuid.UUID, req *UpdateIncidentRequest) (*domain.Incident, error) {
	...
	if s.wsUsecase != nil {
		s.wsUsecase.BroadcastIncidentEvent(domain.WSEventIncidentUpdated, incident.OrganizationID, incident)
	}
...
func (s *IncidentUsecase) ListIncidents(ctx context.Context, orgID uuid.UUID, req *ListIncidentsRequest) (*ListIncidentsResponse, error) {
...
func (s *IncidentUsecase) AddResponder(ctx context.Context, incidentID uuid.UUID, userID uuid.UUID, req *AddResponderRequest) (*domain.IncidentResponder, error) {
